...
%CRA ENGINEER II
	\begin{samepage}
		...
		\begin{itemize}
			\item Was awarded and lead a Phase I SBIR effort to design and prototype a ruggedized touchscreen button interface for Navy aircaft carrier display systems 
			\item Created the large displacement unmanned underwater vehicle [LDUUV] user manual for  asset transfer to the Navy fleet
			\item Lead the redesign of a system of communication, command, and control pressure vessels for unmanned vehicles
		\end{itemize}
	\end{samepage}
	\vspace{.1in}
...
%CRA ENGINEER I
	\begin{samepage}
		...
		\begin{itemize}
			...
			\item Lead the design of operations logistics \& tools for a next generation LDUUV
		\end{itemize}
	\end{samepage}
	\vspace{.1in}
...
%CRA INTERN
	\begin{samepage}
		...
		\href {http://www.cra.com}{\textit{Charles River Analytics}} -- Wakefield, Rhode Island
		\begin{itemize}
			\item Lead the design of an emergency safety system for LDUUVs		
...
\section*{Activities \& Interests}
	\years{2017 - Present}Boxing - \href{http://www.newportboxfit.com}{Newport Boxfit}\\
