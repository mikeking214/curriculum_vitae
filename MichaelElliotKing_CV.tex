...
%CRA ENGINEER I
	\begin{samepage}
		...
		\begin{itemize}
			...
			\item Lead the design of maintenance \& operations logistics of next generation large displacement unmanned underwater vehicle [LDUUV]
		\end{itemize}
	\end{samepage}
	\vspace{.1in}
...
%CRA INTERN
	\begin{samepage}
		...
		\begin{itemize}
			...
			\item Participated in open water autonomy tests of large displacement unmanned underwater vehicles [LDUUV]
		\end{itemize}
	\end{samepage}
	\vspace{.1in}
...
\section*{Activities \& Interests}
	...
	\years{2010 - 2015}Photography - \href{http://www.michaelelliotphotography.com}{www.michaelelliotphotography.com}\\
