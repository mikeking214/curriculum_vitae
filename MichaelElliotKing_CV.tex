...
\end{center}
  ...
  \begin{center}
  % \small
    \Letter \hspace{1pt} \href{mailto:mk@michaelking.io}{mk@michaelking.io} \hspace{.3pt}
    \Mundus \hspace{1pt} \href{http://www.michaelking.io}{michaelking.io}
    ...
    \textifsymbol{23} \hspace{.5pt} 488 Thames St. Newport, RI 02840\\
  \end{center}
...
%CRA ENGINEER II
	\begin{samepage}
		\years{3/2016 - Present} \textbf{\scshape Mechanical Engineer II}\\
		...
		\begin{itemize}
			...
			\item Created the large displacement unmanned underwater vehicle [LDUUV] user manual for  asset transfer to the Navy fleet
			\item Led the redesign of a system of communication, command, and control pressure vessels for unmanned vehicles
		\end{itemize}
	\end{samepage}
	\vspace{.1in}
...
%CRA ENGINEER I
	\begin{samepage}
		\years{3/2015 - 3/2016} \textbf{\scshape Mechanical Engineer I}\\
		\href {http://www.cra.com}{\textit{Charles River Analytics}} -- Wakefield, Rhode Island
		\begin{itemize}
			...
			\item Designed a pressure-balanced oil-filled electronics enclosure \& proved it in a hyberbaric chamber to full ocean depth
			\item Led the design of operations logistics \& tools for a next generation LDUUV
		\end{itemize}
	\end{samepage}
	\vspace{.1in}
...
%CRA INTERN
	\begin{samepage}
		...
		\href {http://www.cra.com}{\textit{Charles River Analytics}} -- Wakefield, Rhode Island
		\begin{itemize}
			\item Led the design of an emergency safety system for LDUUVs		
			\item Operated, tuned, and performed open-water tests of Hydroid REMUS UUVs
			\item Supported open-water autonomy tests of LDUUVs
		\end{itemize}
	\end{samepage}
	\vspace{.1in}
...
%MCGILL ROBOTICS
	\begin{samepage}
		...
		\begin{itemize}
			\item Led all mechanical design, manufacturing and testing for the team of 60 creating an autonomous underwater vehicle 
...
%LUNAREX
	\begin{samepage}
		...
		\begin{itemize}
			...
			\item Led the efforts of a five person group responsible for designing, constructing and assembling the mechanism that collects and dumps lunar regolith simulant
			...
			% \item Documented each step of the design process,  meetings, outreach, and competition with photography
...
\section*{Activities \& Interests}
	\years{2017 - Present}Freediving \& Spearfishing - \href{http://www.nefreedive.com/aboutus.asp}{New England Freedive}, \href{https://www.facebook.com/groups/1995240594091435/}{Tri-State Skin Divers Club}\\
	\years{2017 - Present}Boxing - \href{http://www.newportboxfit.com/private-classes}{Newport Boxfit} (\emph{Trainer: Jesse Macrae})\\
	\years{2016 - Present}Competitive Sailing - \href{http://j24fleet50.org/about-us/}{J/24 Fleet 50 Newport}\\
	\years{2015 - Present}Beach \& Indoor Volleyball - \href{http://www.newportvolleyballclub.com}{Newport Volleyball Club}\\
	\years{2010 - 2015}Photography - \href{https://www.instagram.com/michaelelliotking}{Instagram} (previously michaelelliotphotography.com)\\
...
\begin{center}
{\hspace{-.5in} \scriptsize Last updated \today\- •\- \href{http://www.michaelking.io}{www.michaelking.io}}
\end{center}
