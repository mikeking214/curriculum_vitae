...
\scshape Department~of~Mechanical~Engineering\\
...
%  SUMMARY
\section*{Summary}
I am a recent graduate of McGill University passionate about engineering design, specifically \href{www.michaelelliotking.com/projects/mcgillrobotics}{robotics} and \href{ www.michaelelliotking.com/projects/brailleuniversity}{human computer interaction}. I am currently looking for full time employment starting in September 2014, following my design team commitments.
...
\item Design, simulate, and implement the control \& propulsion system of an unmanned submarine using C++ and ROS [Capstone Project]
\item CAD of the vehicle for FEA, dynamic modeling, 3D printing and simulations
\end{itemize}
\end{samepage}
%\vspace{.05in}
...
%  \begin{samepage}
%  \years{9/2013 - Present} \textbf{\scshape Development of a Variable-Friction Shoe Surface Mechanism}\\
%  {\textit{McGill University Interdisciplinary Design Project}} -- Montreal, Quebec\\
%  {\small Independent, year-long research \& design project}\\
%  {\small Supervised by Professor Jeremy Cooperstock, \textsl {McGill Centre for Intelligent Machines}}
%  \begin{itemize}
%  \item Design and manufacture prototype of mechanism to fit in the sole of a shoe and control the coefficient of friction
%  \end{itemize}
%  \end{samepage}
...
\item Developed work flow and inventory management system
...
Computer Aided Design: \emph{Inventor, AutoCAD, Solidworks}\\
