...
%  ADDRESS & INFO
  ...
  \begin{center}
    \Letter \hspace{3pt} \href{mailto:mk@michaelking.io}{mk@michaelking.io} \hspace{1pt}
    \Mundus \hspace{3pt} \href{http://www.michaelking.io}{michaelking.io}
...
% LUNAREX
  ...
  %   \begin{itemize}
  %     \item Led the efforts of a five person group responsible for designing, manufacturing and assembling the mechanism that collects and dumps lunar regolith simulant
