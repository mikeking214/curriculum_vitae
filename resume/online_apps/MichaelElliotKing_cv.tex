...
%  SUMMARY
\section*{Summary}
	I am a recent graduate of McGill University passionate about engineering design, specifically \href{www.michaelelliotking.com/projects/mcgillrobotics}{robotics} and \href{ www.michaelelliotking.com/projects/brailleuniversity}{human computer interaction}. I am currently looking for full time employment.
...
%MCGILL ROBOTICS
	\begin{samepage}
		\years{8/2013 - 8/2014} \textbf{Co-Founder \& Mechanical Engineering Lead}\\
...
%INTERDISCIPLINARY DESIGN PROJECT
	\begin{samepage}
		\years{9/2013 - 7/2014} \textbf{Development of a Variable-Friction Shoe-Surface Mechanism}\\
...
%MECH ENG PROJECT
	\begin{samepage}
		\years{9/2013 - 5/2014} \textbf{Development of the Propulsion \& Control System for an A.U.V.}\\
...
%LUNAREX
	\begin{samepage}
		\years{8/2012 - 8/2013} \textbf{Material Collection System Leader | Marketing \& Media Director}\\
...
%BRAILLE U
	\begin{samepage}
		...
		\begin{itemize}
			...
			\item Collaborated with Braille education professionals to create an authentic curriculum and legitimate learning tool (Anne Jarry, Nathalie Martiniello: \textit {Univerisite de Montreal})
		\end{itemize}
	\end {samepage}
\vspace{.1in}
