...
\geometry{letterpaper, textwidth=6in, textheight=9in, marginparsep=20pt, marginparwidth=1in} %margin settings
...
\years{\small 2009 - Present} \textbf{B.Eng., Mechanical Engineering}\\
...
%MCGILL ROBOTICS
\begin{samepage}
\years{\small 8/2013 - Present} \textbf{\scshape Mechanical Engineering Leader | Control Systems}\\
...
%ROBIES
\begin{samepage}
\years{\small Summer 2012 \& Summer~2013} \textbf{\scshape Paid Engineering Internship}\\
...
%T DAVLIN
\begin{samepage}
\years{\small Summer 2013} \textbf{\scshape Control Systems \& Engineering Internship}\\
...
{\small Supervisored by Professor Jeremy Coopsertock, \textsl {McGill Center for Intelligent Machines}}
\begin{itemize}
