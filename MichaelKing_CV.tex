\documentclass[12pt, letterpaper]{article} % Document font size and paper size

\usepackage{fontspec} % Allows the use of OpenType fonts

%  LAYOUT
\usepackage{geometry} % Allows the configuration of document margins
\geometry{letterpaper, textwidth=6in, textheight=9in, marginparsep=5pt, marginparwidth=.4in} % Document margin settings
...
\setlength{\marginparsep}{30pt} % Slightly increase the distance of the margin years from the contant
\reversemarginpar

\usepackage[xetex, bookmarks, colorlinks, breaklinks, pdftitle={Michael Elliot King - CV},pdfauthor={Michael Elliot King}]{hyperref} % PDF setup - set your name and the title of the document to be incorporated into the final PDF file meta-information
...
%\usepackage{titlesec} %format the sectioning commands: \titleformat{command}[shape]{format}{label}{sep}{before}[after]
%\titleformat{\section}[runin]{}{}{}{}[] %makes no space after a ``section''
...
% LINKEDIN PHOTO
\newcommand{\linkedin}{%
\begin{tikzpicture}[y=0.18pt, x=0.18pt,yscale=-1, inner sep=0pt, outer sep=0pt,opacity=1]
...
\Mundus \hspace{3pt}  \href{http://www.michaelelliotking.com}{www.michaelelliotking.com}\\
\linkedin \hspace{3pt}\href{http://www.linkedin.com/pub/michael-king/44/5b7/665}{michael-king}
\end{minipage}\\[.1in]

Born: February 14, 1991 --- Qunicy, MA\\
...
\years{2009 - Present} \textbf{B.Eng., Mechanical Engineering}\\
\textit{McGill University,} Montreal, Quebec

%	RELEVANT EXPERIENCE
\section*{\scshape Relevant Experience}

%MCGILL ROBOTICS
\begin{samepage}
\years{8/2013 - Present} \textbf{\scshape Mechanical Engineering Leader | Control Systems}\\
\href {http://mcgillrobotics.com}{\textit{McGill A.U.V. Robotics Design Team}} -- Montreal, Quebec
\begin{itemize}
...
\item Provide company wide technical support
