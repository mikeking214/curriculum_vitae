...
%	FONTS
\setromanfont [Ligatures={Common}, Numbers={OldStyle}]{Linux Libertine} % Main text font
...
\item Design, simulate, and implement control system for the propulsion of an unmanned submarine [Capstone Poject]
